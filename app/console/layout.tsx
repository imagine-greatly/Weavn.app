...
export const metadata: Metadata = {
  ...
  description: "POST any URL. Get structured JSON back — 307 checks, ranked findings, benchmarks, AI-rewritten copy. 25 free scans. Batch endpoint, async mode, webhooks. From $59/mo.",
  openGraph: {
  ...
  twitter: {
    ...
    title: "Weavn API — Website Intelligence for Developers",
    description: "POST any URL → structured JSON. 307 checks. 25 free scans. From $59/mo.",
