export default function DeveloperLoading() {
  return (
    <div style={{ background: "#050810", minHeight: "100svh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
      <style>{`@keyframes purplePulse{0%,100%{opacity:1;transform:scale(1)}50%{opacity:0.3;transform:scale(0.85)}}`}</style>
      <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#9D8CFF", animation: "purplePulse 1.4s ease-in-out infinite" }} />
