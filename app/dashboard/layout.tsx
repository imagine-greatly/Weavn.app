...
export const metadata: Metadata = {
  ...
  description: "Paste any URL. Get a 0–100 conversion score, 307-check conversion analysis, AI-rewritten copy, and corpus benchmarks against real sites in your vertical — in about 90 seconds. No account required.",
  openGraph: {
