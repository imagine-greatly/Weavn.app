...
export const metadata: Metadata = {
  ...
  description: "Paste any URL. Get a 0–100 conversion score, 311-check conversion analysis, AI-rewritten copy, and corpus benchmarks against real sites in your vertical — in 60–120 seconds, scaling with site depth. No account required.",
  openGraph: {
