    ...
    <section style={{ padding: '96px 0', position: 'relative', overflow: 'hidden', background: '#050810' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: '0 48px' }}>
        ...
        <p style={{ ...MONO, fontSize: 12, color: '#6E7587', margin: '0 0 48px', letterSpacing: '0.04em' }}>
          One POST request. 308 checks fire in sequence across 27 categories. Structured JSON returns.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div style={{
            ...
            <div style={{ padding: '0 14px 14px', display: 'flex', gap: 6, flexWrap: 'wrap', position: 'relative', zIndex: 2 }}>
              {[{ l: '308 checks', c: '#00C48C' }, { l: '27 categories', c: '#6F9BC6' }, { l: '~90s median', c: '#6E7587' }].map(x => (
          ...
          <div style={{
            ...
            <div style={{ padding: '10px 14px', borderBottom: '0.5px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ ...MONO, fontSize: 10, color: '#6E7587', marginLeft: 'auto' }}>ai · 308 checks</span>
            </div>
            ...
            <div style={{ padding: '10px 14px 14px' }}>
              <span style={{ ...MONO, fontSize: 11, color: '#404860' }}>running 308 checks · 27 categories</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                  {['308 checks', '~90s median', 'cache hits free'].map(label => (
...
<span style={{ color: '#6E7587' }}>{'}'}</span>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
          ...
          <div style={{ ...PANEL, padding: 'clamp(20px, 3vw, 32px)' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { t: 'What it checks', lead: null, body: "308 checks across 27 conversion categories — hero, trust, CTA, social proof, and more — run against the exact page you submit." },
      ...
      <section style={{ position: 'relative', overflow: 'hidden', borderTop: '0.5px solid rgba(255,255,255,0.08)' }}>
        ...
        {/* Ambient purple section bloom — rises from low-center, fades to transparent before the section edges (below content) */}
        <div aria-hidden style={{
          position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0,
          background: 'radial-gradient(ellipse 72% 95% at 50% 105%, rgba(157,140,255,0.11) 0%, rgba(157,140,255,0.046) 38%, transparent 82%)',
        }} />
        <Ticks />
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 896, margin: '0 auto', padding: '64px 32px 72px' }}>
          ...
          <div style={{ marginTop: 24 }}>
            <p style={{ ...MONO, fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.18em', color: '#6E7587', margin: '0 0 10px' }}>
              CHECK CATEGORIES · 27 GROUPS · 308 CHECKS
            </p>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', background: '#080D18', borderTop: '0.5px solid rgba(255,255,255,0.08)' }}>
        ...
        {/* Ambient purple section bloom — centered, fades to transparent before all section edges (below content) */}
        <div aria-hidden style={{
          position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0,
          background: 'radial-gradient(ellipse 80% 80% at 50% 50%, rgba(157,140,255,0.11) 0%, rgba(157,140,255,0.046) 38%, transparent 82%)',
        }} />
        <Ticks />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-0">
              {[
                ...
                },
                {
                  ...
                  detail: 'The engine runs 308 checks per URL. Parallel execution — a 10-URL batch completes in roughly the same wall time as one.',
      ...
      <section style={{ position: 'relative', overflow: 'hidden', borderTop: '0.5px solid rgba(255,255,255,0.08)' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 720, margin: '0 auto', padding: '72px 32px', textAlign: 'center' }}>
          <p style={{ ...MONO, fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.15em', color: '#8080c0', margin: '0 0 12px' }}>Ready to build?</p>
          <h2 style={{ ...DISP, fontSize: 'clamp(26px, 3.5vw, 38px)', fontWeight: 700, letterSpacing: '-0.5px', color: '#E6E9EE', lineHeight: 1.2, margin: '0 0 12px' }}>25 free scans. No subscription. Start in minutes.</h2>
          <p style={{ ...SANS, fontSize: 14, lineHeight: 1.6, color: '#9398A8', margin: '0 0 28px' }}>Same engine on every plan. Build against the schema once.</p>

          {/* Primary GET API KEY + secondary READ THE DOCS — API-forward */}
