          ...
          <div>
            ...
            >
              ...
              <ScrollReveal variant="card" index={2}>
                <p>
                  WebDoc maps that gap with 264 checks across 27 categories, cites evidence from your pages, and outputs resolutions ranked by revenue impact.
                </p>
              </ScrollReveal>
            </div>
          </div>
    ...
    <section className="relative w-full overflow-hidden py-[120px] px-6">
      <div className="mx-auto max-w-[min(1100px,calc(100vw-48px))] text-center">
        ...
        <p
          ...
          style={{ color: "var(--text-secondary)" }}
        >
          WebDoc runs 264 checks across 27 categories. Each finding ties directly to conversion suppression and revenue impact.
        </p>
