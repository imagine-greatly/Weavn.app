...
export const metadata = {
  ...
  description: "Terms governing your use of the WebDoc AI platform.",
};
    ...
    <div style={{ background: BG, minHeight: "100vh" }}>
      ...
      >
        ...
        <Section title="Acceptance and Data Retention">
          <P>
            By using WebDoc you agree to our data retention policy as described in these Terms and
            in our{" "}
          ...
          <P>
            ...
            submitted to WebDoc — including URLs, rendered HTML content, and AI-generated diagnostic
        ...
        <Section title="Platform Access and Eligibility">
          <P>
            ...
            WebDoc. Accounts are for individual use; sharing credentials is not permitted. You are
        ...
        <Section title="Publicly Accessible Website Data">
          <P>
            WebDoc operates by retrieving and analyzing publicly accessible web pages. We reserve
          ...
          <P>
            ...
            analysis, or that the URL is publicly accessible and you are using WebDoc for legitimate
        ...
        <Section title="Acceptable Use">
          <P>
            You agree not to use WebDoc to: submit URLs you are not authorized to analyze; attempt
          ...
          <P>
            WebDoc is a diagnostic tool. The reports and recommendations generated by the platform
        ...
        <Section title="Intellectual Property">
          <P>
            The WebDoc platform, including its software, design, AI models, and diagnostic
            methodology, is owned by WebDoc AI and protected by applicable intellectual property
        ...
        <Section title="Disclaimers and Limitation of Liability">
          <P>
            WebDoc is provided "as is" without warranties of any kind, express or implied. We do
          ...
          <P>
            To the maximum extent permitted by law, WebDoc's total liability to you for any claim
            arising from these Terms or your use of the platform shall not exceed the amounts you
            paid to WebDoc in the twelve months preceding the claim. We are not liable for any
        ...
        <Section title="Changes to These Terms">
          <P>
            ...
            email or a notice on the platform. Your continued use of WebDoc after the effective date
        ...
        <Section title="Governing Law">
          <P>
            These Terms are governed by the laws of the jurisdiction in which WebDoc AI is
        ...
        <Section title="Contact">
          <P>
            ...
            <a
              href="mailto:legal@webdocai.com"
