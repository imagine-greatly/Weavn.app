...
ABOVE-FOLD PRIORITY:
The HTML contains a [WEAVN: estimated viewport boundary]
...
- TRUNCATED CONTENT — If you see a [WEAVN: content truncated] comment in any page content, do NOT generate findings about content being cut off, incomplete, or mid-sentence — this is a technical scraper limitation not a real page issue. Only flag content issues when incompleteness is clearly structural.`;
}
