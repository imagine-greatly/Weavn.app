...
export const METRIC_KEYS: readonly string[] = [
  // benchmark / stat fields
  'score', 'industry_avg', 'top_quartile', 'percentile', 'severity',
  // canonical dimension score keys (7 total)
  'conversion_architecture', 'trust_signals', 'message_clarity',
  'traffic_readiness', 'technical_foundation', 'objection_handling', 'offer_clarity',
];
