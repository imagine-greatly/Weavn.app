...
const SUBPAGE_BLOCKLIST = /\/(login|signin|logout|sign-out|admin|dashboard|account|profile|settings|privacy|terms|policy|cookies|legal|compliance|security|trust|blog\/[^\/]+|news\/[^\/]+|press\/[^\/]+|media\/[^\/]+|customers\/[^\/]+|case-studies\/[^\/]+|stories\/[^\/]+|solutions\/[^\/]+|use-cases\/[^\/]+|industries\/[^\/]+|integrations\/[^\/]+|apps\/[^\/]+|marketplace\/[^\/]+|plugins\/[^\/]+|docs\/[^\/]+|documentation\/[^\/]+|guides\/[^\/]+|tutorials\/[^\/]+|changelog\/[^\/]+|releases\/[^\/]+|careers|jobs|hiring|team|people|about\/team|investors|press-kit|brand|assets|download|downloads|install|affiliate|referral|partner\/[^\/]+|sitemap|rss|feed|404|error|gaming|game|games|store|shop(?!\/)|cart|checkout|order|status|uptime|incident)(?:[-\/]|$)/i;
...
const CONVERSION_SCORES: Record<SiteType, Array<{ pattern: RegExp; score: number }>> = {
  saas: [
    { pattern: /^\/pricing\/?$/i, score: 200 },
    { pattern: /^\/plans?\/?$/i, score: 195 },
    { pattern: /\/pricing/i, score: 150 },
    { pattern: /\/plans?/i, score: 145 },
    { pattern: /\/features\/?$/i, score: 130 },
    { pattern: /\/platform\/?$/i, score: 125 },
    { pattern: /\/product\/?$/i, score: 120 },
    { pattern: /\/signup|\/register/i, score: 100 },
    { pattern: /\/demo|\/book-demo/i, score: 95 },
    { pattern: /\/solutions\/?$/i, score: 90 },
    { pattern: /\/how-it-works\/?$/i, score: 85 },
    { pattern: /\/testimonials|\/reviews/i, score: 80 },
    { pattern: /\/about\/?$/i, score: 60 },
    { pattern: /\/contact\/?$/i, score: 50 },
  ],
  ecommerce: [
    { pattern: /^\/membership\/?$/i, score: 200 },
    { pattern: /^\/pricing\/?$/i, score: 195 },
    { pattern: /\/pricing|\/membership|\/plans?/i, score: 150 },
    { pattern: /^\/collections?\/?$/i, score: 130 },
    { pattern: /^\/products?\/?$/i, score: 125 },
    { pattern: /\/collections?|\/products?/i, score: 110 },
    { pattern: /\/bestsellers?|\/featured/i, score: 95 },
    { pattern: /\/sale|\/deals/i, score: 90 },
    { pattern: /\/reviews|\/testimonials/i, score: 80 },
    { pattern: /\/about\/?$/i, score: 60 },
    { pattern: /\/faq/i, score: 50 },
  ],
  service: [
    { pattern: /^\/pricing\/?$/i, score: 200 },
    { pattern: /^\/membership\/?$/i, score: 195 },
    { pattern: /^\/plans?\/?$/i, score: 190 },
    { pattern: /\/pricing|\/membership|\/plans?/i, score: 150 },
    { pattern: /\/services\/?$/i, score: 130 },
    { pattern: /\/what-we-do\/?$/i, score: 125 },
    { pattern: /\/services|\/what-we-do/i, score: 110 },
    { pattern: /\/testimonials|\/reviews/i, score: 95 },
    { pattern: /\/about\/?$/i, score: 85 },
    { pattern: /\/contact\/?$/i, score: 75 },
    { pattern: /\/how-it-works\/?$/i, score: 65 },
    { pattern: /\/faqs?/i, score: 55 },
  ],
  local: [
    { pattern: /^\/services\/?$/i, score: 200 },
    { pattern: /\/services|\/what-we-do/i, score: 150 },
    { pattern: /^\/about\/?$/i, score: 130 },
    { pattern: /^\/contact\/?$/i, score: 120 },
    { pattern: /\/reviews|\/testimonials/i, score: 110 },
    { pattern: /\/about|\/team/i, score: 100 },
    { pattern: /\/contact/i, score: 90 },
    { pattern: /\/faqs?/i, score: 70 },
  ],
  content: [
    { pattern: /^\/subscribe\/?$/i, score: 200 },
    { pattern: /^\/pricing\/?$/i, score: 195 },
    { pattern: /\/subscribe|\/newsletter/i, score: 150 },
    { pattern: /\/pricing|\/plans?/i, score: 145 },
    { pattern: /^\/about\/?$/i, score: 130 },
    { pattern: /\/start|\/begin/i, score: 100 },
    { pattern: /\/topics?|\/categories/i, score: 70 },
  ],
  unknown: [
    { pattern: /^\/pricing\/?$/i, score: 200 },
    { pattern: /^\/plans?\/?$/i, score: 195 },
    { pattern: /\/pricing|\/plans?/i, score: 150 },
    { pattern: /\/features|\/services/i, score: 130 },
    { pattern: /^\/about\/?$/i, score: 120 },
    { pattern: /\/testimonials|\/reviews/i, score: 100 },
...
async function fetchSubpageFast(url: string, abortMs: number, complexity?: SiteComplexity): Promise<string | null> {
  ...
  const subpageWait = complexity === 'simple' ? 700 : complexity === 'complex' ? 1600 : 1100
